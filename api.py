...
'''
Writing to file (better to use my_stock_stream immediately as a dict)
my_stock_stream = get_stock_stream('AAPL')
with open('stock_stream.csv', 'w') as outfile:
    json.dump(my_stock_stream, outfile)
    '''
